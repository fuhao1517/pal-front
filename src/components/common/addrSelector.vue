<template>
  <div class="addr-main" ref="addrMain">
    <el-popover
      ...
      <div slot="reference" @click.stop="visible=true" :style="{width: inputWidth}">
      <el-input
        :placeholder="placeholder?placeholder:'请选择'"
        suffix-icon="ic-addr"
        v-model="inputVal" style="width: 100%" @input="handleInput" @focus.stop="isSearch=false" @blur="handleBlur">
      </el-input>
      </div>
    </el-popover>
  </div>
...
export default {
  ...
  props: ['value', 'width', 'addrArr', 'placeholder', 'valueField'],
  model: {
    prop: 'value',
    event: 'change'
  },
