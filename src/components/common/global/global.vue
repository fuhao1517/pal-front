...
const pswRegExp = '^[A-Za-z0-9]{6,}$' // 密码正则
const pswRegExpMsg = '密码由6位以上的数字、字母组成' // 密码正则-提示信息
...
var noTokenUrl = ['/api/sys/login', '/api/sys/mobile/send/code', '/api/sys/mobile/validate/code']
