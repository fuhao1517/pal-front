<template>
  <div class="spl-container content">
    ...
    <dTable @fetch="getTableData" ref="salaryTable" class="mb-30" style="position: relative;" :tableHeight="tableHeight" :showIndex="true" :showSelection="true">
      <el-table-column prop="failReason" align="center" label="失败原因" width="300" :show-overflow-tooltip="true"></el-table-column>
      ...
      <el-table-column prop="perforDateStr" align="center" label="绩效年月" width="210" :show-overflow-tooltip="true"></el-table-column>
      ...
      <template slot="pagination-btns">
        <footer class="comment">
          <el-button size="small" type="primary" @click="handleExport(switchValue)"><i class="ic-export-white"></i> 导出</el-button>
    ...
    <footer class="comment text-center">
      <el-button class="s-btn w-90" type="primary" @click="handleSave"> 保存</el-button>
      <el-button class="btn--border-blue w-90 s-btn" style="margin-left: 60px" @click="returnPage()"> 取消</el-button>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        pathData: [{ name: '人员管理' }, { name: '绩效管理' }, { name: '导入绩效' }],
        mainLoading: false,
        dialogVisible: false,
        accumForm: {
          taxMonth: '',
    ...
    methods: {
      ...
      handleSave () {
        ...
        this.$http({
          url: '/api/employee/checkPerFormanceImportSave',
          method: 'post',
      ...
      /* 模板下载 */
      handleDownload () {
        this.$downloadFile('/api/employee/downloadPerformanceTemplate', 'get', {
        }, this.$global.EXCEL)
      },
      /* 动态文件名称改变 */
      ...
      uploadSuccess (response, file, fileList) {
        ...
        this.fileId = fileId
        this.$http({
          url: '/api/employee/import/perFormanceImport',
          method: 'post',
          data: this.$qs.stringify({
            fileId: fileId
          })
      ...
      getTableData (params = []) {
        ...
        this.$refs.salaryTable.fetch({
          query: params,
          method: 'post',
          url: '/api/employee/checkPerformanceImportList'
        })
      },
      /* 只看失败 */
      changeStatus (value) {
      ...
      getImportCountInfo () {
        this.$http({
          url: '/api/employee/checkPerformanceImportCount',
          method: 'post',
          data: this.$qs.stringify({
            fileId: this.fileId
          })
      ...
      handleExport (switchValue) {
        ...
        this.$downloadFile('/api/employee/checkPerFormanceImportPageExport', 'post', {
          params
        }, this.$global.EXCEL)
      },
      /* 删除 */
      handleDelete () {
        ...
        this.$http({
          url: '/api/employee/checkPerFormanceImportDel',
          method: 'post',
          data: {
            ids: ids
          }
